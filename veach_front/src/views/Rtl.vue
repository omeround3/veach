  ...
  <div class="py-4 container-fluid">
      ...
      <div class="col-lg-12 position-relative z-index-2">
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <mini-statistics-card :title="{ text: 'أموال اليوم', value: '$53k' }"
              detail="<span class='text-success text-sm font-weight-bolder'>+55%</span> من الأسبوع الماضي" :icon="{
                name: 'weekend',
                color: 'text-white',
                background: 'dark',
              }" />
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <mini-statistics-card :title="{ text: 'مستخدمو اليوم', value: '2,300' }"
              detail="<span class='text-success text-sm font-weight-bolder'>+3%</span> من الأسبوع الماضي" :icon="{
                name: 'leaderboard',
                color: 'text-white',
                background: 'primary',
              }" />
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <mini-statistics-card :title="{ text: 'عملاء جدد', value: '34K' }"
              detail="<span class='text-danger text-sm font-weight-bolder'>+1%</span> من الشهر الماضي" :icon="{
                name: 'store',
                color: 'text-white',
                background: 'success',
              }" />
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 mt-lg-0 mt-4">
            <mini-statistics-card :title="{ text: 'مبيعات', value: '+91' }"
              detail="<span class='text-success text-sm font-weight-bolder'>+5%</span> مقارنة بيوم أمس" :icon="{
                name: 'weekend',
                color: 'text-white',
                background: 'info',
              }" />
        ...
        <div class="row mt-4">
          ...
          <div class="col-lg-4 col-md-6 mt-4">
            <chart-holder-card title="Daily Sales"
              ...
              update="تم التحديث منذ 4 دقائق" color="success">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6">
        <timeline-list class="h-100" title="نظرة عامة على الطلبات" description="<i class='material-icons text-sm text-success' aria-hidden='true'>north</i>
        <span class='font-weight-bold'>24%</span>هذا الشهر">
          <timeline-item :icon="{
            component: 'notifications',
            class: 'text-success',
          }" title="$2400, تغييرات في التصميم" date-time="22 ديسمبر 7:20 مساءً" />
          <TimelineItem :icon="{
            component: 'code',
            class: 'text-danger',
          }" title="طلب جديد # 1832412" date-time="21 ديسمبر 11 م" />
          <TimelineItem :icon="{
            component: 'shopping_cart',
            class: 'text-info',
          }" title="مدفوعات الخادم لشهر أبريل" date-time="21 ديسمبر 9:34 مساءً" />
          <TimelineItem :icon="{
          ...
          <TimelineItem :icon="{
            component: 'vpn_key',
            class: 'text-primary',
          }" title="فتح الحزم من أجل التطوير" date-time="18 ديسمبر ، 4:54 صباحًا" />
          <TimelineItem :icon="{
            component: 'bug_report',
            class: 'text-dark',
          }" title="طلب جديد # 9583120" date-time="17 ديسمبر" />
        </timeline-list>
      </div>
    </div>
  </div>
